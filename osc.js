...
function getJSONosc() {
	return '{"name": "osc","filename": "osc.dsp","version": "2.32.13","compile_options": "-lang wasm -es 1 -single -ftz 2","library_list": ["/usr/local/share/faust/stdfaust.lib","/usr/local/share/faust/basics.lib","/usr/local/share/faust/maths.lib","/usr/local/share/faust/platform.lib","/usr/local/share/faust/signals.lib","/usr/local/share/faust/oscillators.lib"],"include_pathnames": ["/usr/local/share/faust","/usr/local/share/faust","/usr/share/faust",".","/tmp/sessions/687BEC68681C213035BD1E244BB137C832056BA5/web/wasmjs"],"size": 262296,"inputs": 0,"outputs": 2,"meta": [ { "basics.lib/name": "Faust Basic Element Library" },{ "basics.lib/version": "0.1" },{ "compile_options": "-lang wasm -es 1 -single -ftz 2" },{ "filename": "osc.dsp" },{ "maths.lib/author": "GRAME" },{ "maths.lib/copyright": "GRAME" },{ "maths.lib/license": "LGPL with exception" },{ "maths.lib/name": "Faust Math Library" },{ "maths.lib/version": "2.3" },{ "name": "osc" },{ "oscillators.lib/name": "Faust Oscillator Library" },{ "oscillators.lib/version": "0.1" },{ "platform.lib/name": "Generic Platform Library" },{ "platform.lib/version": "0.1" },{ "signals.lib/name": "Faust Signal Routing Library" },{ "signals.lib/version": "0.0" }],"ui": [ {"type": "vgroup","label": "Oscillator","items": [ {"type": "hslider","label": "lr_offset","address": "/Oscillator/lr_offset","index": 262268,"init": 0,"min": 0,"max": 1,"step": 1e-05},{"type": "hslider","label": "mix","address": "/Oscillator/mix","index": 262176,"init": 0.5,"min": 0,"max": 1,"step": 0.01},{"type": "hslider","label": "shift","address": "/Oscillator/shift","index": 262232,"meta": [{ "unit": "hz" }],"init": 2.2,"min": -20,"max": 20,"step": 0.001},{"type": "hslider","label": "shift_scalar","address": "/Oscillator/shift_scalar","index": 262228,"init": 6,"min": 1,"max": 100,"step": 0.1},{"type": "hslider","label": "volume","address": "/Oscillator/volume","index": 262152,"meta": [{ "unit": "dB" }],"init": 0,"min": -96,"max": 0,"step": 0.1}]}]}';
}
/*
 faust2webaudio
